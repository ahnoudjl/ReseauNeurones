...
public class TestPorteLogiqueImplication {
	public static void main(String[] args) {
		//Initialisation des échantillons
		Echantillon echantillon1 = new Echantillon(new double[]{0,0},1);
		Echantillon echantillon2 = new Echantillon(new double[]{0,1},1);
		Echantillon echantillon3 = new Echantillon(new double[]{1,0},0);
		...
		NeuroneEntree neuroneE1 = new NeuroneEntree(new double[] {-1,0});
		NeuroneEntree neuroneE2 = new NeuroneEntree(new double[] {0,1});
		NeuroneEntree[] neuronesEntree = new NeuroneEntree[] {neuroneE1, neuroneE2};
		NeuroneCache neuroneC1 = new NeuroneCache(new double[] {1}, -1);
		NeuroneCache neuroneC2 = new NeuroneCache(new double[] {1}, 0);
